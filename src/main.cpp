...
int main() {
    ...
    Range hero {
        RangeNode { .hand = handsForRanges[ 0 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 1 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 2 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 3 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 4 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 5 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 6 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 7 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 8 ], .handWeight = 0.8 },
        RangeNode { .hand = handsForRanges[ 9 ], .handWeight = 0.8 },
